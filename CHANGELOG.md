...
Further reduced the homepage-only hero after reviewing the live site in Chrome at a 14-inch laptop viewport. Tightened its headline scale, vertical padding, grid gap, action spacing, avatar height, and note padding so the hero no longer consumes nearly the full visible screen and the beginning of the next section appears below it. Interior page heroes remain unchanged.
...
Initial GitHub setup for the recovered Netlify static site.
